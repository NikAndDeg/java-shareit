...
VALUES (1, '1item', 'description', 'true'),
       (2, '2item', 'description', 'true');

INSERT INTO bookings(booking_status_id, item_id, user_id, booking_start, booking_end)
VALUES (1, 1, 2, '2020-01-01 12:00:00', '2021-01-01 12:00:00'),
       (2, 1, 2, '2020-01-01 12:00:00', '2030-01-01 12:00:00'),
       (3, 1, 2, '2030-01-01 12:00:00', '2040-01-01 12:00:00');