...
class UserServiceImplTest {
	...
	@Test
	void test_addUser_with_name_is_blank() {
		userDtoTo = UserDto.builder()
				.name(" ")
				.email("user@email.com")
				.build();
		Exception exception = assertThrows(BadRequestException.class,
				() -> service.addUser(userDtoTo));
		assertEquals("User not saved. User with empty name.", exception.getMessage());
	}

	@Test
	void test_addUser_with_name_is_null() {
		userDtoTo = UserDto.builder()
				.email("user@email.com")
				.build();
		Exception exception = assertThrows(BadRequestException.class,
	...
	@Test
	void test_addUser_with_email_is_blank() {
		userDtoTo = UserDto.builder()
				.name("user")
				.email(" ")
				.build();
		Exception exception = assertThrows(BadRequestException.class,
				() -> service.addUser(userDtoTo));
		assertEquals("User not saved. User with empty email.", exception.getMessage());
	}

	@Test
	void test_addUser_with_email_is_null() {
		userDtoTo = UserDto.builder()
				.name("user")
				.build();
		Exception exception = assertThrows(BadRequestException.class,
